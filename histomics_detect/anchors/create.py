...
def create_anchors(anchor_px, field, width, height):
    ...
    regression branches of the region proposal network. We represent anchors using their 
    centroid in pixels relative to the upper left corner of the input image.
