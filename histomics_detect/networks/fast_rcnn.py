...
def fast_rcnn(features, dense=[4096, 4096], activations=['relu', 'relu'], pool=2, tiles=3):
    """
    ...
    for i, (unit, activation) in enumerate(zip(dense, activations)):
        if i == 0:
            layer_input = pooled
        else:
            layer_input = x
